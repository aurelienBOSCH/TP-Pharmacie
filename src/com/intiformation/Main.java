...
public class Main
{
	...
	public static Medicament lireMedicament()
	{
		...
		do
		{
			...
			if (!verif)
				System.out.println("Medicament non trouvé");
	...
	public static void ajoutMedoc()
	{
		...
		System.out.println("Le medicament " + m.getNom() + ", au prix unitaire de : " + m.getPrix()
